...
public class Controller {
    ...
    private String createTableLek = "CREATE TABLE IF NOT EXISTS Lek(id bigint GENERATED BY DEFAULT AS IDENTITY, nazwa varchar(20), cena decimal(10,2), ilosc int, producentId int FOREIGN KEY REFERENCES Producent (id));";
    ...
    private boolean AddingLek(Lek lek)
    {
        try
        {
